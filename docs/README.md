...
ImageKid is currently an offline native macOS image utility with basic video viewing. AI upscaling has been removed from the active scope and may be reconsidered only after the core product is complete.
