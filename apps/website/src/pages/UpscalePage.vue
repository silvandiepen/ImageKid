...
const data: ProductPageData = {
  ...
  features: [
    ...
    { title: "Pick a scale", description: "2×, 4×, 8×, or a custom percentage — set it once and it applies to the whole queue." },
    ...
    { title: "Serial & predictable", description: "Processes one image at a time to keep memory and heat under control, with cancel and retry." },
